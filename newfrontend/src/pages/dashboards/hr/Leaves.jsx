...
// NOTE: Assuming a placeholder reviewer ID for PATCH requests
const REVIEWER_ID = 'hr-admin-123'; 
...
const HRLeavePage = () => {
    ...
    const updateLeaveStatus = async (id, action) => {
        ...
        setError(null);
        try {
            // Determine the endpoint: 'approve' or 'reject'
            const url = `${API_BASE_URL}/${id}/${action}`;
            
            await api.patch(url, { reviewerId: REVIEWER_ID });
    ...
    const LeaveRow = ({ leave }) => {
        const employeeName = leave.employeeId?.name || 'Unknown Employee';
        ...
        return (
            <tr className="border-b hover:bg-gray-50">
                ...
                <td className="py-3 px-3 capitalize">{leave.type || 'Annual'}</td>
            ...
            <div className="flex-1 flex flex-col">
                ...
                <main className="flex-1 p-4 sm:p-6 lg:p-8">
                    ...
                    <div className="bg-white rounded-lg shadow-xl p-6 border border-gray-200">
                        ...
                        {/* Filter Section (GET /leaves & GET /leaves/:employeeId) */}
